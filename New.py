...
def login():
	...
	try:
		...
		print
		id=raw_input(S + '[👉] ' + S + 'Email/number/username: ' + G +'')
...
def menu():
	...
	print (S + '[' + P + '👉3' + S + ']' + S + ' Contact In Facebook For Any Help')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/HUNTERDEVILL')
...
def pb():
	...
	psb(S + '[☆]' + S + ' M4RMU Tool Started Cloning Please Wait........... .To stop process  click on CTRL ~ Z')
	print
	print (S + 50*'-')
	print
	def main(arg):
